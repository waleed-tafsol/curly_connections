  ...
  Widget build(BuildContext context) {
    final List<Map<String, dynamic>> reviews = [
      ...
      },
      {
        ...
        'rating': '4.7',
        'comment':
            'Great experience! The staff was very friendly and attentive, and the massage was top-notch.',
      },
      {
        'initials': 'AM',
        'name': 'Alice Morgan',
        ...
        'rating': '5.0',
        'comment':
            'Absolutely wonderful! The facial treatment left my skin glowing, and I felt rejuvenated after.',
      },
      {
        'initials': 'AM',
        'name': 'Alice Morgan',
